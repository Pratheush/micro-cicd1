package com.example.pbookmark.observe;
 ...
 * InstallOpenTelemetryAppender What it does: Logback > OpenTelemetryAppender > OTLP exporter > Grafana Loki
 * Without this call: OpenTelemetryAppender.install(openTelemetry) logs will not connect to the OpenTelemetry SDK.
 */
@Component
